...
my_cols_LR <- c("strong decrease [< log(0.5)]" = "#d7191c",
...
# checks:
comp_df %>% select(verbatimIdentification, datasetID, Jacc_pred, LogRatio_y_pred, LogRatio_pred) %>% head()
...
factor_levels_LR <- c("strong decrease [< log(0.5)]",
...
# Reorder columns
dat_cat_wide <- dat_cat_wide[, c("datasetID",
                                 "verbatimIdentification",
                                 "J_Predicted",
                                 "trend_J_Predicted",
                                 "J_Observed",
...
fig1_LR_past
# export::graph2ppt(fig1_LR_past, here::here("Figures/A_data/D_02_Fig1_LnRR_Histograms.pptx"),  width = 8, height = 4)
# ggsave("Figures/A_data/D_02_LogRatio_Histogram.svg", fig1_LR_past, width = 4, height = 2)
...
# export::graph2ppt(fig1_J_past, here::here("Figures/A_data/D_02_Fig1_J_Histograms.pptx"),  width = 8, height = 4)
# ggsave("Figures/A_data/D_02_J_Histogram.svg", fig1_J_past, width = 4, height = 2)
